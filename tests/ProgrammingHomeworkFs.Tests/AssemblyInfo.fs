...
[<assembly: AssemblyTitleAttribute("ProgrammingHomeworkFs.Tests")>]
[<assembly: AssemblyProductAttribute("ProgrammingHomeworkFs")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "ProgrammingHomeworkFs.Tests"
    let [<Literal>] AssemblyProduct = "ProgrammingHomeworkFs"
