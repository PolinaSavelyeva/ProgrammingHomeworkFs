    ...
    let tests =
        testList "SimpleFunctions tests" [
            ...
            <| fun _ ->
                ...
                Expect.equal actualResult -8000000
                    "Fast exponentiation -200 x 3 = -8000000"
            ...
            <| fun _ ->
                let actualResult =
                    arrays [|
                        ...
                        11
                    |]
                Expect.equal actualResult 1110
            ...
            <| fun _ ->
                let actualResult =
                    arrays [|
                        ...
                        -1000
                    |]
                Expect.equal actualResult 2332141
            ...
            <| fun _ ->
                ...
                Expect.equal actualResult 0
                    "Maximum - minimum of [|1|] = 0"
            testCase "arrays test -- no values array"
            <| fun _ ->
                let actualResult =
                    Expect.throws (fun _ -> arrays [||] |> ignore)
            ...
            <| fun _ ->
                let actualResult =
                    arrays [|
                        ...
                        0
                    |]
                Expect.equal actualResult 21859.22
            ...
            <| fun _ ->
                let actualResult =
                    ...
                    |]
                Expect.equal actualResult 0
                    "Maximum - minimum of [|2.2; 2.2; 2.2; 2.2|] = 0"
